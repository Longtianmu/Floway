  ...
  translation: {
    ...
    dashboard: {
      ...
      playground: {
        ...
        responsesLiteHint: 'Uses the Codex Responses Lite wire profile on /v1/responses. Function and custom tools are grouped into the functions namespace; remote image URLs are omitted because Lite requires inline data URLs.',
      ...
      upstreamEditor: {
        ...
        models: {
          ...
          responsesTransportHint: 'Choose Responses Lite only when the upstream model advertises that wire profile. Floway moves instructions and client tools into the required leading input items and sends the internal Lite marker.',
