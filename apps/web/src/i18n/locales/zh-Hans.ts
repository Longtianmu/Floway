  ...
  translation: {
    ...
    dashboard: {
      ...
      apiDocs: {
        ...
        groups: { models: '模型发现', generation: '文本与多模态生成', media: 'Embedding、图像与音频', safety: '安全', rerank: 'Rerank 协议', search: 'Codex 搜索' },
        endpointNames: {
          ...
          openAiEmbeddings: 'OpenAI Embeddings', openAiImageGeneration: 'OpenAI 图像生成', openAiImageEdit: 'OpenAI 图像编辑', openAiTranscription: 'OpenAI 音频转录', openAiModerations: 'OpenAI 内容审核',
      ...
      upstreamEditor: {
        ...
        models: {
          ...
          yamlModerationRequiresCustom: '内容审核模型需要使用自定义上游',
          yamlRerankRequiresCustom: '重排模型需要使用自定义上游',
          yamlTitle: '模型 YAML',
          rerankPath: '路径覆盖',
          ...
          source: '配置方式',
          kind: '类型',
          kindValue: { chat: '对话', embedding: '嵌入', image: '图像', moderation: '内容审核', transcription: '转录', rerank: '重排' },
          actions: '操作',
          copy: '复制模型 ID',
          editNamed: '编辑模型 {{name}}',
          back: '返回模型列表',
      ...
      modelAliases: {
        ...
        kind: { 'chat': '对话', 'embedding': '嵌入', 'image': '图像', 'moderation': '内容审核', 'rerank': '重排', 'transcription': '转录' }, selection: { first: '首个可用', random: '随机' }, visibility: { visible: '可见', hidden: '隐藏' },
