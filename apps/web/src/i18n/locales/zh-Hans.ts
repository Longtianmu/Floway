  ...
  translation: {
    ...
    dashboard: {
      ...
      playground: {
        ...
        responsesLiteHint: '在 /v1/responses 上使用 Codex Responses Lite 线协议。函数与自定义工具会归入 functions 命名空间；Lite 要求内联 data URL，因此远程图片 URL 会被省略。',
      ...
      upstreamEditor: {
        ...
        models: {
          ...
          responsesTransportHint: '仅当上游模型声明使用此线协议时选择 Responses Lite。Floway 会把指令和客户端工具移入必需的前置输入项，并发送内部 Lite 标记。',
          capabilities: '能力与限制',
          contextWindow: '上下文窗口',
